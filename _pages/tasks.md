...
The task is structured as a <b>binary-classification problem</b> and defined as following: ``Given a piece of text $t$, assign it the label 0, if the text is written by a human, and 1 otherwise.``
